			...
			<tr>
				...
				<table id="__01" width="739" height="571" border="0" cellpadding="0" cellspacing="0">
					<tr>
						...
						<div style="padding-top:23px; margin-left:23px; color:#989931; font-size:13px; font-weight:bold"><% if trim(request("lei"))<>"" then 
					...
					<tr>
						...
						<div id="neiye_main">
								...
								<a href="product_in.asp?categoryID=<%=rs("categoryID")%>&amp;itemid=<%=rs("id")%>" ><img src="<%=rs("Field_picture")%>" width="160" height="130"/></a>
																	...
																	<tr>
																	  <td height="23"   align="center" valign="middle"><span style="line-height:100%"><a href="product_in.asp?categoryID=<%=rs("categoryID")%>&amp;itemid=<%=rs("id")%>"><%=rs("Title")%></a></span></td>
																	</tr>
																	</table>	
													</td>
													<% 
